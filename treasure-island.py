...
if direction == 'left':
  action = input("Excellent. Would you like to swim through the lake or wait for a bus?").lower()
  if action == "wait":
    ...
    if door == 'blue':
      ...
      print("You are safe and are the sole owner of the treasure! Congratulations, you win the game!")
    else:
      print("You have gone missing and will probably die. Game Over!")
  else:
    print("You have drown and sharks are eating your flesh! Game Over!")
else:
